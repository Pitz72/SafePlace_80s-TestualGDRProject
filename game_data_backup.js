    ...
    FOREST: [
        {
            ...
            choices: [
                ...
                {
                    text: "Ignora e tira dritto",
                    outcome: "La prudenza è la miglior consigliera. Prosegui senza voltarti."
                }
            ]
        },
        {
...
const ITEM_DATA = {
    ...
    'water_dirty': {
        id: 'water_dirty',
        name: "Acqua Sporca",
        description: "Acqua raccolta da una fonte dubbia. Berla così com'è è molto rischioso.",
        usable: false, // Non si può bere direttamente
        type: 'resource_raw',
        effect: null
        // Potrebbe essere usata per crafting (purificazione) in futuro
    }
